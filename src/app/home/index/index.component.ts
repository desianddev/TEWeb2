...
export class IndexComponent implements OnInit {
  ...
  tournamentList: any = [
    ...
    { src: 'https://tournamentedition.com/assets/images/object1.png', title: 'WC 2022' },
  ...
  trusted: any = [
    { logosrc: '/assets/img/fight_sessions_logo.png', logotitle: 'FightSessions', logosource: 'https://twitter.com/FightSessions/' },
